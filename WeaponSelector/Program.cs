...
namespace WeaponSelector
{
    public class Program
    {
        ...
        private static Weapons ParseWeapons(string[] args)
        {
            ...
            Weapons weapons = ParseWeapons(args);
        ...
        private static bool WeaponsKillEnemy(EnemyType enemy, Weapons weapons)
        {
            ...
            bool dies = WeaponsKillEnemy(enemy, weapons);
            ...
            if (enemy == EnemyType.Vampire)  & (weapons == Weapons.Garlic | Weapons.HolyWater)
            {
                return dies;
            }

            if (enemy == EnemyType.Werewolf) & (weapons == Weapons.SilverBullet)
            {
                return dies;
            }
